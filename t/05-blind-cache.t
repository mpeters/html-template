...
ok(
    copy('templates/simplemod.tmpl', 'templates/simple.tmpl'),
...
ok(
    copy('templates/notsosimple.tmpl', 'templates/simple.tmpl'),
    "able to restore original content of simple.tmpl"
);
ok(unlink('templates/notsosimple.tmpl'), "able to unlink temporary file");
